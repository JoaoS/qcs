 ...
 * 
 */
@WebServiceClient(name = "InsulinDoseCalculatorService", targetNamespace = "http://server/", wsdlLocation = "http://webservice-sqdcourse.rhcloud.com/InsulinDoseCalculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://webservice-sqdcourse.rhcloud.com/InsulinDoseCalculator?wsdl");
